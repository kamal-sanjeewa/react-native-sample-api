    ...
    const onSubmitDeposit = ()=>{
        ...
        if(Number.isNaN(amountInNumber)){
            ...
            if(amountInNumber < 0){
                ...
                const transaction: Transaction = {debitCredit: "credit", value: amountInNumber, bankBalance: bankBalanceState.balance + amountInNumber };
                dispatch(addtransaction(transaction))
                dispatch(withdrawDeposit(amountInNumber));
                Alert.alert(
                    'Sucess',
                    'Your deposit has been updated.',
                    [{text: 'Okay', onPress: () => console.log()}],
                    {
                      cancelable: false,
                    }
